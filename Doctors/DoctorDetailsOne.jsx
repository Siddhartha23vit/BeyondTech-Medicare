...
import DoctorAbout from './DoctorAbout1';
import Feedback from './Feedback';
import SlidePanel from './SlidePanel1';
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <h3 className="text-headingColor text-[22px] leading-9 mt-3 font-bold">Neeraj Chopra</h3>
